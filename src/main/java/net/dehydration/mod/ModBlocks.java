...
public class ModBlocks {
	...
	public static BlockEntityType<CampfireCauldronEntity> CAMPFIRE_CAULDRON_ENTITY = FabricBlockEntityTypeBuilder
			.create(CampfireCauldronEntity::new, CAMPFIRE_CAULDRON_BLOCK).build(null);
	public static final BlockEntityType<BambooPumpEntity> BAMBOO_PUMP_ENTITY = FabricBlockEntityTypeBuilder
			.create(BambooPumpEntity::new, BAMBOO_PUMP_BLOCK).build(null);
	...
	private static Block register(Identifier id, boolean addItemGroup, Block block) {
		if (addItemGroup) {
			...
			ItemGroupEvents.modifyEntriesEvent(ModItems.DEHYDRATION_ITEM_GROUP).register(entries -> entries.add(item));
		}

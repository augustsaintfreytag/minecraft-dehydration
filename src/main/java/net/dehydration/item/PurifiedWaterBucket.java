...
public class PurifiedWaterBucket extends Item implements FluidModificationItem {
	...
	public boolean placeFluid(@Nullable PlayerEntity player, World world, BlockPos pos,
		...
		boolean bl = blockState.canBucketPlace(ModFluids.PURIFIED_WATER);
		bl2 = blockState.isAir() || bl || block instanceof FluidFillable && ((FluidFillable) ((Object) block))
				.canFillWithFluid(world, pos, blockState, ModFluids.PURIFIED_WATER);
		if (!bl2) {
